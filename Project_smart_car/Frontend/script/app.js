...
// This function shows the historiek
...
// Get the history with an API call (see backend)
const getHistoriek = function(){
  handleData(`http://192.168.168.168:5000/api/v1/historiek`, showHistoriek)
}

// Listen to the UI of the site and do something.
const listenToUI = function () {
  // If the user is on the main (index) page.
    if(htmlTemp){
      // Let the contactButton on the site do something (go to a new sheet of the site).
    ...
    // Let the historyButton on the site do something (go to a new sheet of the site).
    ...
    // Let the parkingSensButton on the site do something (go to a new sheet of the site).
    ...
    // Let the buttonbuzzerONOFF on the site do something (go to a new sheet of the site).
    ...
    buttonbuzzerONOFF.addEventListener('click', function(){
      ...
      if(tellerBuzzer == 1){
          // console.log(buttonONOFF.classList) --> to check the classList of the button.
  ...
  // Let the light button on the site do something (change of the layout an send it to the backend).
  ...
  tellerLights = 0
    ...
    // Let the ON/OFF button on the site do something (change the layout and turn the RPI off by sending it to the backend).
  ...
  // If the user is on the info page.
    if(htmlInfo){
      // Let the contactButton on the site do something (go to a new sheet of the site).
      const contactButton = document.querySelector('.js-buttonContact');
      contactButton.addEventListener('click', function(){
  ...
  if(htmlContact){
    ...
    // Let the homeButton on the site do something (go to a new sheet of the site).
    ...
    // Let the infoButton on the site do something (go to a new sheet of the site).
...
const listenToSocket = function () {
  ...
  // If the user is on the maine page (index) of the site.
  if(htmlTemp){
    // Listen to "B2F_verstuur_data_ldr" and do things.
  ...
  // Listen to "B2F_verstuur_data_dallas" and do things.
    ...
    // Listen to "B2F_state_with_button" and do things.
  ...
  // If the user is on the parkingSensor page of the site.
  // This part of the code servers for the UI of the parkig sensors. This will decide which block needs to light up and which not.
...
// If the user is on the parkingSensor page of the site.
  ...
  socket.on('B2F_history', function(){
    // console.log("jaaaaaaaaaaaaaaaaaaaaaaaa") --> This was to test if it was working.
    getHistoriek()
  })
}
...
// Declaration of parts of the html page.
const init = function(){
